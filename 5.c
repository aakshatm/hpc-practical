...
void *fun1();
void *fun2();
int shared = 500;  // shared variable
...
void *fun1()
{
    ...
    pthread_mutex_lock(&l); // thread one acquires the lock. Now thread 2 will not be able to acquirelock    until it is unlocked by thread 1
